...
OWNER_CHANNEL = "cinemalu_adda"
OWNER = "@Cinemalu_Adda"
#MAIN_CHANNEL = -1002705260914
METASUFFIX = "CinemaluAdda"
    ...
    try:
        ...
        async with download_semaphore:
            ...
            if platform == "TMDB" and "magnet_streams" in content_info:
                ...
                if (platform_lower in ["tubi", "pluto tv", "hbo max", "ullu", "etv win", "mxplayer"] and not formats_from_parser) or \
            ...
            # Start the progress updater for the upload phase
            updater_task = asyncio.create_task(
                update_user_task_progress(identifier, progress_msg)
            )
            progress_data['updater_task'] = updater_task
            download_progress.update_progress(identifier, progress_data)
    ...
    try:
        ...
        if action == "res":
            ...
            progress_msg = await client.send_message(
                chat_id=callback_query.message.chat.id,
                text="Download Initiated, this may take some time..."
            )
